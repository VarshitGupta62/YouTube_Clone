                ...
                <div className="mt-4">
                  ...
                  <div>
                        <div className="border-b border-b-gray-100">
                          <ul className="-mb-px flex items-center gap-5 text-lg font-medium">
                            <li>
                              <Link className="inline-flex cursor-pointer items-center gap-2 px-1 py-3 text-gray-500 hover:text-black">
                              <img
                                className="w-12 h-12 rounded-full"
                                src={image}
                                alt="User"
                            ...
                            <li>
                              ...
                              <span className="rounded-full bg-gray-100 px-2 py-0.5 text-xs font-semibold text-gray-500"> {videoData.views}  </span> 
                              </Link>
                            </li>
                            <li>
                              <Link className="inline-flex cursor-pointer items-center gap-2 px-1 py-3 text-gray-500 hover:text-black">
                              ...
                              <span className="rounded-full bg-gray-100 px-2 py-0.5 text-xs font-semibold text-gray-500">{formatDate(videoData.createdAt)}</span> 
                              </Link>
                            </li>
                          </ul>
                        </div>
